...
public class BitmapUtil
{
    ...
    {
        return createBitmap(view, Bitmap.Config.ARGB_8888);
    }
    ...
    public static Drawable getDrawable(Activity context, int resId)
    {
    ...
    public static Bitmap getBitmap(Activity context, int resId)
    {
        ...
        return getBitmap(context.getResources().getDrawable(resId));
    }
    ...
    public static boolean saveBitmap2Jpeg(Bitmap bitmap, String fileName)
    {
        return saveBitmap(bitmap, Bitmap.CompressFormat.JPEG, fileName);
    }

    public static boolean saveBitmap2Png(Bitmap bitmap, String fileName)
    {
        return saveBitmap(bitmap, Bitmap.CompressFormat.PNG, fileName);
    }

    public static boolean saveBitmap(Bitmap bitmap, Bitmap.CompressFormat format, String fileName)
    {
        ...
        try {
            ...
            return saveBitmap(bitmap, format, fOut);
        }
        catch (IOException e) {
            e.printStackTrace();
            return false;
    ...
    public static boolean saveBitmap2Jpeg(Bitmap bitmap, Bitmap.CompressFormat format, OutputStream out)
    {
        return saveBitmap(bitmap, Bitmap.CompressFormat.JPEG, out);
    }

    public static boolean saveBitmap2Png(Bitmap bitmap, Bitmap.CompressFormat format, OutputStream out)
    {
        return saveBitmap(bitmap, Bitmap.CompressFormat.PNG, out);
    }

    public static boolean saveBitmap(Bitmap bitmap, Bitmap.CompressFormat format, OutputStream out)
    {
     ...
     * @param img1
     */
    public Bitmap getGrayBitmap(Bitmap img1)
    {
