...
public class ImageDownloader
{
    ...
    private void forceDownload(String url, ImageView imageView)
    {
        ...
        if (cancelPotentialDownload(url, imageView)) {
            switch (mode) {
                case NO_ASYNC_TASK:
                    File dir = AndroidUtil.getApplicationExternalStorage(imageView.getContext(), "cache");

                    String extName = FileUtil.getExtFromName(url);
    ...
    Bitmap downloadBitmap(String url, File file)
    {
            ...
            if (entity != null) {
                ...
                try {
                    ...
                    if (file != null) {
                        ...
                        try {
                            StreamUtil.streamCopy(inputStream, fileOut);
                        }
                        finally {
    ...
    class BitmapDownloaderTask extends AsyncTask<String, Void, Bitmap>
    {
        ...
        protected Bitmap doInBackground(String... params)
        {
            ...
            String extName = FileUtil.getExtFromName(url);
            String fileName = Base64.encodeToString(url);
