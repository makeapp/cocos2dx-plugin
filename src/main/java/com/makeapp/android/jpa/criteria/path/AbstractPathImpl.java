...
/**
 * Convenience base class for various {@link javax.persistence.criteria.Path} implementors.
 *
        ...
        implements Path<X>, PathImplementor<X>, Serializable
{
    ...
    {
        getPathSource().prepareAlias(renderingContext);
        AbstractAttribute attrs = (AbstractAttribute) getAttribute();

        return getPathSource().getPathIdentifier() + "." + attrs.getProperty().getColumeName();
    }
