...
/**
 * {@link javax.persistence.criteria.MapJoin#key} poses a number of implementation difficulties in terms of the type signatures
 * amongst the {@link javax.persistence.criteria.Path}, {@link javax.persistence.criteria.Join} and {@link javax.persistence.metamodel.Attribute} reference at play.  The implementations found here
 * provide that bridge.
 *
...
public class MapKeyHelpers
{
    ...
    /**
     * Defines a {@link javax.persistence.criteria.Path} for the map which can then be used to represent the source of the
     * map key "attribute".
     *
...
//        private final org.hibernate.type.Type mapKeyType;
        ...
        private final BindableType jpaBindableType=null;
        private final Class<K> jpaBinableJavaType=null;
        private final PersistentAttributeType persistentAttributeType=null;
