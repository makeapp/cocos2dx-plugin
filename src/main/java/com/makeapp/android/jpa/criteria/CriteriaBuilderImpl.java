...
import com.makeapp.android.jpa.criteria.expression.*;
import com.makeapp.android.jpa.criteria.expression.function.*;
import com.makeapp.android.jpa.criteria.path.PluralAttributePath;
import com.makeapp.android.jpa.criteria.predicate.*;
...
import static com.makeapp.android.jpa.criteria.predicate.ComparisonPredicate.ComparisonOperator;

/**
 * Hibernate implementation of the JPA {@link javax.persistence.criteria.CriteriaBuilder} contract.
 *
...
public class CriteriaBuilderImpl implements CriteriaBuilder, Serializable
{
    ...
    public CriteriaBuilderImpl(EntityManagerFactory entityManagerFactory)
    {
        this.entityManagerFactory = entityManagerFactory;
    }

    /**
     * Provides protected access to the underlying {@link EntityManagerFactory}.
     *
     * @return The underlying {@link EntityManagerFactory}
     */
     ...
     * {@link javax.persistence.criteria.CriteriaQuery#multiselect(java.util.List)}  method.
     *
     * @param selections The selection varargs to check
     * @throws IllegalArgumentException If, as per
     *                                  {@link javax.persistence.criteria.CriteriaQuery#multiselect(java.util.List)} documentation,
    ...
    /**
     * Version of {@link #tuple(javax.persistence.criteria.Selection[])} taking a list.
     *
    ...
    /**
     * Version of {@link #array(javax.persistence.criteria.Selection[])} taking a list of selections.
     *
     * @param selections List of selections.
    ...
    /**
     * Version of {@link #construct(Class, javax.persistence.criteria.Selection[])} taking the
    ...
    public <T> In<T> inCollection(Expression<? extends T> expression, Collection<T> values)
    {
        return new InPredicate<T>(this, expression, values);
    }
