...
public class MetamodelImpl implements Metamodel, Serializable
{
     ...
     */
    public static MetamodelImpl buildMetamodel(List<EntityClass> persistentClasses)
    {
        MetadataContext context = new MetadataContext();
        for (EntityClass ec : persistentClasses) {
            locateOrBuildEntityType(ec, context);
        }
        context.wrapUp();
        return new MetamodelImpl(context.getEntityTypeMap(), context.getEmbeddableTypeMap());
    }

    private static EntityTypeImpl<?> locateOrBuildEntityType(EntityClass persistentClass, MetadataContext context)
    {
    ...
    private static EntityTypeImpl<?> buildEntityType(EntityClass persistentClass, MetadataContext context)
    {
        final Class javaType = persistentClass.getClazz();
        context.pushEntityWorkedOn(persistentClass);
        final MappedSuperclass superMappedSuperclass = null;
